        ...
        <table class="table table-hover display" id="_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><a class="text-decoration-none text-dark" href="{{route('testimonials.edit', $testimonial->id)}}"><img src="{{asset('assets_admin/images/edit-svgrepo-com.svg')}}"></a></td>
              <td class="text-center">
                <form action="{{ route('testimonials.delete', $testimonial['id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                  @csrf
                  @method('DELETE')
