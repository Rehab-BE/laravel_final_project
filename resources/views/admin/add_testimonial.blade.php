        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{route('categories.create')}}l">Add category</a></li>
                <li>
                  <hr class="dropdown-divider" />
                </li>
    ...
    <div class="mx-2">
      ...
      <form action="{{route('testimonials.store')}}" method="post" class="px-md-5" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="text" placeholder="e.g. Jhon Doe" class="form-control py-2" name="testimonial_name" value="{{old('testimonial_name')}}" />
