...
<head>
    ...
    <link href="{{asset('assests_public/css/bootstrap.min.css')}}" rel="stylesheet">

    <link href="{{asset('assests_public/css/bootstrap-icons.css')}}" rel="stylesheet">

    <link href="{{asset('assests_public/css/templatemo-topic-listing.css')}}" rel="stylesheet">
    <!--
...
<body id="top">
                    ...
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="{{route('topic_list')}}">Topics Listing</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                        <div class="custom-block bg-white shadow-lg">
                            <a href="topics-detail.html">
                                ...
                                <img src="{{asset('assests_public/images/topics/undraw_Remote_design_team_re_urdx.png')}}"
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-block custom-block-overlay">
                            <div class="d-flex flex-column h-100">
                                <img src="{{asset('assests_public/images/businesswoman-using-tablet-analysis.jpg')}}"
                                    class="custom-block-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Redesign_feedback_re_jvm0.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/colleagues-working-cozy-office-medium-shot.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_online_ad_re_ol62.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Group_video_re_btu7.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_viral_tweet_gndb.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="finance-tab-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12 mb-4 mb-lg-0">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Finance_re_gnv2.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="custom-block custom-block-overlay">
                                            <div class="d-flex flex-column h-100">
                                                <img src="{{asset('assests_public/images/businesswoman-using-tablet-analysis-graph-company-finance-strategy-statistics-success-concept-planning-future-office-room.jpg')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Compose_music_re_wpiw.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_happy_music_g6wc.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Podcast_audience_re_4i5q.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Graduation_re_gthn.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{asset('assests_public/images/topics/undraw_Educator_re_ju47.png')}}"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12">
                        <img src="{{asset('assests_public/images/faq_graphic.jpg')}}" class="img-fluid" alt="FAQs">
                    </div>
                    ...
                    <div class="carousel-inner">
                            ...
                            <div class="row mx-md-5">
                                <div class="col-md-4 testimonials">
                                    <img class="d-block rounded-3"
                                        src="{{asset('assests_public/images/testimonials/janis-dzenis-jkvE9uJN3jk-unsplash.jpg')}}"
                                        alt="First slide">
                                </div>
                        ...
                        <div class="carousel-item">
                            <div class="row mx-md-5">
                                <div class="col-md-4 testimonials">
                                    <img class="d-block rounded-3"
                                        src="{{asset('assests_public/images/testimonials/janis-dzenis-oPRubjbiqKI-unsplash.jpg')}}"
                                        alt="First slide">
                                </div>
                                <div class="col-md-8 px-md-5 d-flex flex-column justify-content-center">
                                    <h3>Jone Due<br><strong class="date">12/02/2019</strong></h3>
                        ...
                        <div class="carousel-item">
                            <div class="row mx-md-5">
                                <div class="col-md-4 testimonials">
                                    <img class="d-block rounded-3"
                                        src="{{asset('assests_public/images/testimonials/rocky-xiong-UE04nFCgDUE-unsplash.jpg')}}"
                                        alt="First slide">
                                </div>
                                <div class="col-md-8 px-md-5 d-flex flex-column justify-content-center">
                                    <h3>Jone Due<br><strong class="date">12/02/2019</strong></h3>
    ...
    <!-- JAVASCRIPT FILES -->
    <script src="{{asset('assests_public/js/jquery.min.js')}}"></script>
    <script src="{{asset('assests_public/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assests_public/js/jquery.sticky.js')}}"></script>
    <script src="{{asset('assests_public/js/click-scroll.js')}}"></script>
    <script src="{{asset('assests_public/js/custom.js')}}"></script>
