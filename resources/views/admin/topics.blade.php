        ...
        <table class="table table-hover display" id="_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><a class="text-decoration-none text-dark" href="{{route('topics.edit',$topic->id)}}"><img src="{{asset('assets_admin/images/edit-svgrepo-com.svg')}}"></a></td>
              <td class="text-center">
                <form action="{{ route('topics.delete', $topic['id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                  @csrf
                  @method('DELETE')
